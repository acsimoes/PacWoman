...
void PlayingState::draw(sf::RenderWindow& window)
{
	...
	// sf::FloatRect pacBox = m_pacWoman->getCollisionBox();
	// sf::RectangleShape pacR(sf::Vector2f(pacBox.width, pacBox.height));
	// pacR.setPosition(sf::Vector2f(pacBox.left, pacBox.top));
	// window.draw(pacR);
	// for (Ghost* ghost : m_ghosts)
	// {
	// 	sf::FloatRect ghostBox = ghost->getCollisionBox();
	// 	sf::FloatRect instersection;
	// 	if(ghost->getCollisionBox().intersects(m_pacWoman->getCollisionBox(), instersection));
	// 	{
	// 		std::cout << "ghostBox = \n" << "Left:\t" << ghostBox.left << "\tTop:\t" << ghostBox.top << "\nwidth:\t" << ghostBox.width << "\theight:\t" << ghostBox.height << std::endl;
	// 		std::cout << "m_pacWoman = \n" << "Left:\t" << pacBox.left << "\tTop:\t" << pacBox.top << "\nwidth:\t" << pacBox.width << "\theight:\t" << pacBox.height << std::endl;
	// 		std::cout << "instersection = \n" << "Left:\t" << instersection.left << "\tTop:\t" << instersection.top << "\nwidth:\t" << instersection.width << "\theight:\t" << instersection.height << std::endl;
	// 	}

	// 	sf::RectangleShape ghostR(sf::Vector2f(ghostBox.width, ghostBox.height));
	// 	ghostR.setPosition(sf::Vector2f(ghostBox.left, ghostBox.top));
	// 	sf::RectangleShape inter(sf::Vector2f(instersection.width,instersection.height));
 //    	inter.setPosition(sf::Vector2f(instersection.left, instersection.top));
	// 	window.draw(ghostR);
	// 	window.draw(inter);
	// }
